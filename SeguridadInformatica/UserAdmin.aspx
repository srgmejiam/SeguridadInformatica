<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="UserAdmin.aspx.cs" Inherits="SeguridadInformatica.administracionUsuarios" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <asp:UpdatePanel runat="server" ID="UpPanelAdminusuario">
        <ContentTemplate>
